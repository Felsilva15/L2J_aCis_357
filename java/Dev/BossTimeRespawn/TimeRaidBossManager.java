...
public class TimeRaidBossManager {
    ...
    /**
     * Calcula o delay em milissegundos até o próximo respawn configurado para o boss,
     * considerando a lista de horários.
     * Se não houver respawns configurados, retorna -1.
     * @param bossId 
     * @return 
     */
    public long getMillisUntilNextRespawn(int bossId) {
        ...
        for (RespawnTime rt : respawns) {
            ...
            ZonedDateTime nextRespawn = now.with(TemporalAdjusters.nextOrSame(javaDay))
                    .withHour(rt.getHour())
    ...
    /**
     * Converte o valor 1..7 do XML para o enum DayOfWeek Java (1=Monday, 7=Sunday).
     * XML usa 1=Sunday...7=Saturday, converter para Java.
     * @param xmlDay 
     * @return 
     */
