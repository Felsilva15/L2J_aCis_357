...
public final class Config
{
	...
	/** Main */
	public static final String NETWORK_FILE = "./config/gameserver.properties";
	...
	public static final String PARTY_FILE = "./config/party.properties";
	...
	public static final String LOGGING = "./config/logging.properties";
	...
	public static final String PC_BANG_FILE = "./config/aCis/Eventos/PcBang.properties";
	public static final String MISSION_FILE = "./config/aCis/Eventos/Mission.properties";
	public static final String PVPKING_FILE = "./config/aCis/Eventos/PvPKing24hrs.properties";
	public static final String FARM_TIME_FILE = "./config/aCis/Eventos/TimeFarm.properties";
	public static final String CHAMPION_EVENT = "./config/aCis/Eventos/ChampionInvade.properties";
	
	/** Custom */
	public static final String DEATH_BUFFS_FILE = "./config/aCis/DeathBuffLocation.properties";
	public static final String L2JSERVER_FILE = "./config/aCis/L2Server.properties";
	public static final String ENCHANT_FILE = "./config/aCis/Enchant.properties";
	public static final String PHYSICS_FILE = "./config/aCis/balance/Physics.properties";
	public static final String BALANCE_SKILLS_FILE = "./config/aCis/balance/Skills_chance_modifier.properties";
	public static final String OLY_CLASS_DAMAGES_FILE = "./config/aCis/balance/Damages_inOly.properties";
	public static final String OLYMPIAD_PHYSICS_FILE = "./config/aCis/balance/Physics_inOly.properties";
	
	public static final String PHANTOM_FILE = "./config/aCis/phantom/PhantomPlayers.properties";
	public static final String PROTECT_FILE = "./config/aCis/Protect.properties";
	public static final String OFFLINE_SYSTEM_FILE = "./config/aCis/OfflineSystem.properties";
	//public static final String D_GUARD_FILE = "./config/aCis/Protect.properties";

	public static final String Duelist_FILE = "./config/aCis/balance/classes/duelist_vs_class.properties";
	public static final String DreadNought_FILE = "./config/aCis/balance/classes/DreadNought_vs_class.properties";
	public static final String Phoenix_Knight_FILE = "./config/aCis/balance/classes/tankers/phoenix_knight_vs_class.properties";
	public static final String Hell_Knight_FILE = "./config/aCis/balance/classes/tankers/hell_knight_vs_class.properties";
	public static final String Sagittarius_FILE = "./config/aCis/balance/classes/archers/sagitarius_vs_class.properties";
	public static final String Eva_Templar_FILE = "./config/aCis/balance/classes/tankers/eva_templar_vs_class.properties";
	public static final String Sword_Muse_FILE = "./config/aCis/balance/classes/tankers/sword_muse_vs_class.properties";
	public static final String Moonlight_Sentinel_FILE = "./config/aCis/balance/classes/archers/moonlight_sentinel_vs_class.properties";
	public static final String Shillien_Templar_FILE = "./config/aCis/balance/classes/tankers/shillien_templar_vs_class.properties";
	private static final String Spectral_Dancer_FILE = "./config/aCis/balance/classes/spectral_dancer_vs_class.properties";
	private static final String Ghost_Sentinel_FILE = "./config/aCis/balance/classes/archers/ghost_sentinel_vs_class.properties";
	private static final String Titan_FILE = "./config/aCis/balance/classes/titan_vs_class.properties";
	private static final String Grand_Khauatari_FILE = "./config/aCis/balance/classes/grand_khavatari_vs_class.properties";
	private static final String Fortune_Seeker_FILE = "./config/aCis/balance/classes/fortune_seeker_vs_class.properties";
	private static final String Maestro_FILE = "./config/aCis/balance/classes/maestro_vs_class.properties";
	private static final String Adventurer_FILE = "./config/aCis/balance/classes/daggers/adventurer_vs_class.properties";
	private static final String Wind_Rider_FILE = "./config/aCis/balance/classes/daggers/wind_rider_vs_class.properties";
	private static final String Ghost_Hunter_FILE = "./config/aCis/balance/classes/daggers/ghost_hunter_vs_class.properties";
	private static final String Archmage_FILE = "./config/aCis/balance/classes/mages/archmage_vs_class.properties";
	private static final String Soultaker_FILE = "./config/aCis/balance/classes/mages/soultaker_vs_class.properties";
	private static final String Arcana_Lord_FILE = "./config/aCis/balance/classes/mages/arcana_lord_vs_class.properties";
	private static final String Cardinal_FILE = "./config/aCis/balance/classes/mages/cardinal_vs_class.properties";
	private static final String Hierophant_FILE = "./config/aCis/balance/classes/mages/hierophant_vs_class.properties";
	private static final String Mystic_Muse_FILE = "./config/aCis/balance/classes/mages/mystic_muse_vs_class.properties";
	private static final String Elemental_Master_FILE = "./config/aCis/balance/classes/mages/elemental_master_vs_class.properties";
	private static final String Eva_s_Saint_FILE = "./config/aCis/balance/classes/mages/eva_s_saint_vs_class.properties";
	private static final String Storm_Screamer_FILE = "./config/aCis/balance/classes/mages/storm_scream_vs_class.properties";
	private static final String Spectral_Master_FILE = "./config/aCis/balance/classes/mages/spectral_master_vs_class.properties";
	private static final String Shillien_Saint_FILE = "./config/aCis/balance/classes/mages/shillien_saint_vs_class.properties";
	private static final String Dominator_FILE = "./config/aCis/balance/classes/mages/dominator_vs_class.properties";
	private static final String Doomcryer_FILE = "./config/aCis/balance/classes/mages/doomcryer_vs_class.properties";

	public static String TIMED_ITEMS;
	public static List<Integer> LIST_TIMED_ITEMS = new ArrayList<>();
	...
	//Anunciar a porcentagem de HP do L2RaidBossInstance
	public static boolean ANNOUNCE_RAIBOSS_HP;
	//Anunciar a porcentagem de HP do L2GrandBossInstance
	public static boolean ANNOUNCE_GRANDBOSS_HP;
	...
	public static boolean ALLOW_PARTYFARM_DIE_LEAVE_BUFF;
	...
	/** Instance Farm */
	public static boolean OPEN_EFFECT_CLASSIC_TELEPORTER_FARM;
...
//	public static ArrayList<Integer> LIST_RAID_ANNOUNCE = new ArrayList<>();
	...
	//----------------------------------------
	/** Champion Mod */
	public static int NPC_ANT_PK;
	public static int RANGE_BOW_ATTACK_ANTPK;
	...
	public static boolean  ENABLE_XP_SP_DOUBLE;
	...
	//----------------------------------------
	/** Sieges */
	public static boolean BLOCK_DUALBOX_SIEGEZONE;
	...
	public static boolean RESTART_BY_TIME_OF_DAY_LOGIN;
	public static String[] LOGIN_RESTART_INTERVAL_BY_TIME_OF_DAY;
	...
	/** Variaveis LuckBox NEW v1 e v2 */
	public static List<int[]> LUCKY_BOX_REWARDS = new ArrayList<>();
	public static List<int[]> LUCKY_BOX2_REWARDS = new ArrayList<>();
	...
	private static final void loadBoss()
	{
		...
		ENABLE_FULL_HP_RECALL_EPIC = boss.getProperty("RecoverHPFullRecallEpic", false);
		RANGE_EPICBOSS = boss.getProperty("ReturnEpicBossRange", 300);
		RANGE_BOSS_LIMIT = boss.getProperty("ReturnBossRange", 300);
		ENABLE_FULL_HP_RECALL_BOSS = boss.getProperty("RecoverHPFullRecallBoss", false);
		//Anunciar a porcentagem de HP do L2RaidBossInstance
		ANNOUNCE_RAIBOSS_HP = boss.getProperty("EnableRaidBossHpAnnounce", false);
		//Anunciar a porcentagem de HP do L2GrandBossInstance
		ANNOUNCE_GRANDBOSS_HP = boss.getProperty("EnableGrandBossHpAnnounce", false);
	...
	//	}
		ANNOUNCE_RAIDBOS_KILL = Boolean.parseBoolean(boss.getProperty("AnnounceRaidBossKill", "false"));
        ANNOUNCE_GRANDBOS_KILL = Boolean.parseBoolean(boss.getProperty("AnnounceGranBossKill", "false"));
        ANNOUNCE_BOSS_ALIVE =  Boolean.parseBoolean(boss.getProperty("AnnounceSpawnAllBoss", "false"));
	...
	private static final void loadNpcs()
	{
		...
		NPC_ANT_PK = npcs.getProperty("NpcAntiPKID", 0);
		RANGE_BOW_ATTACK_ANTPK = npcs.getProperty("RangeBowAntPK", 0);
		...
		SHOW_RED_NAME_CHAMPION = Boolean.parseBoolean(npcs.getProperty("EnableRedNameChampion", "True"));
	...
	private static final void loadRates()
	{
		...
		ENABLE_XP_SP_DOUBLE =  rates.getProperty("EnableDoubleAllRates", false);
	...
	private static final void loadSieges()
	{
		...
		BLOCK_DUALBOX_SIEGEZONE = sieges.getProperty("NoDualBoxSiegeZone", false);
	...
	private static final void loadSkills()
	{
		...
		KEEP_SUBCLASS_SKILLS = Boolean.parseBoolean(skills.getProperty("AcumularSubClasse", "False"));
	...
	private static final void loadDeathLocation()
	{
		...
		ALLOW_PARTYFARM_DIE_LEAVE_BUFF = Boolean.parseBoolean(deathbufflocation.getProperty("AllowDeathBuffPartyFarm", "False"));
	 ...
	 * Loads l2jserver settings.
	 */
	private static final void loadL2JServer()
	{
		final ExProperties l2jserver = initProperties(L2JSERVER_FILE);
	    NO_USE_FARM_IN_PEACE_ZONE = Boolean.parseBoolean(l2jserver.getProperty("BlockAutoFarmPeaceZone", "false"));
	    ENABLE_NEW_TITLE_AUTOFARM = Boolean.parseBoolean(l2jserver.getProperty("EnableTitleAutoFarm", "false"));
	    NEW_TITLE_AUTOFARM = l2jserver.getProperty("NewTitleAutoFarm", "Farmando!");
	    ENABLE_AURA_AUTOFARM =  Boolean.parseBoolean(l2jserver.getProperty("EnableAuraAutoFarm", "false"));
		ENABLE_AUTO_FARM_COMMAND = Boolean.parseBoolean(l2jserver.getProperty("EnableCommandAutoFarm", "false"));
		ENABLE_COMMAND_VIP_AUTOFARM = Boolean.parseBoolean(l2jserver.getProperty("EnableAutoFarmOnlyVip", "false"));
		ENABLE_DUALBOX_AUTOFARM = Boolean.parseBoolean(l2jserver.getProperty("BlockAutoFarmIP", "false"));
		NUMBER_BOX_IP_AUTOFARM  = Integer.parseInt(l2jserver.getProperty("MaxBoxAutoFarmUsed", "1"));
		ENABLE_GRADE_ITEMS_MARKETPLACE = Boolean.parseBoolean(l2jserver.getProperty("EnableGradeItemsMarket","False"));
		for (String list : l2jserver.getProperty("GradeItemsMarketPlace", "A;S").split(";"))
		GRADE_ITEMS_MARKETPLACE.add(CrystalType.valueOf(list));
		ITEMS_NO_RULES_MARKETPLACE_ID = l2jserver.getProperty("ItemNoBlockMarketPlace", "0,0");
		...
		TICKET_MARKE_PLACE = Integer.parseInt(l2jserver.getProperty("TicketMarkePlace", "6392"));
		ENABLE_AUCTION_COMMUNITY = l2jserver.getProperty("EnableCommunityAuction", false);
		COR_LOJA_AUCTION_ANUNCIE = Integer.parseInt(l2jserver.getProperty("ColorChatAnnuncieAuction", "6392"));
		String[] properSplit = l2jserver.getProperty("CBBMarketPlaceFee", "0,0").split(",");
		try
		{
		...
		catch (NumberFormatException nfe)
		{
			...
			{
				_log.warning("l2jserver: invalid config property -> MarketPlaceFee");
			}
		}
		TIMED_ITEMS = l2jserver.getProperty("ListOfTimedItems");
		TIMED_ITEM_TIME = Integer.parseInt(l2jserver.getProperty("TimedItemTime", "2"));
		
		// Limpando a lista e preenchendo com os itens configurados
		LIST_TIMED_ITEMS.clear();
		for (String id : TIMED_ITEMS.trim().split(",")) {
			LIST_TIMED_ITEMS.add(Integer.parseInt(id.trim()));
		}
		//Solo Farm Random 1
		ITEM_COUNT_ROLETA = l2jserver.getProperty("CountItemRoulette", 0);
		CUSTOM_ITEM_ROULETTE = l2jserver.getProperty("CustomItemRoulette", 0);
		OPEN_EFFECT_CLASSIC_TELEPORTER = Boolean.parseBoolean(l2jserver.getProperty("EnableTeleportClassic", "False"));
		String custom_spawn_location = l2jserver.getProperty("TeleportRandomSoloFarm1", "113852,-108766,-851");
		...
		//Solo Farm Random 2
		String custom_spawn_location2 = l2jserver.getProperty("TeleportRandomSoloFarm2", "113852,-108766,-851");
		...
		//Solo Farm Random 3
		String custom_spawn_location3 = l2jserver.getProperty("TeleportRandomSoloFarm3", "113852,-108766,-851");
		...
		//Solo Farm Random 4
		String custom_spawn_location4 = l2jserver.getProperty("TeleportRandomSoloFarm4", "113852,-108766,-851");
		...
		//Solo Farm Random 5
		String custom_spawn_location5 = l2jserver.getProperty("TeleportRandomSoloFarm5", "113852,-108766,-851");
		...
		//Solo Farm Random 6
		String custom_spawn_location6 = l2jserver.getProperty("TeleportRandomSoloFarm6", "113852,-108766,-851");
		...
		AGATHION_ID_RESTRICT = l2jserver.getProperty("ItemsNullAgathionID");
		...
		String[] AgathionSkillsSplit = l2jserver.getProperty("AgathionSkills", "").split(";");
		...
		STRING_MULTISELL_DONATE = l2jserver.getProperty("MultisellDonateName", "MultisellNew");
		SHOW_FILE_GM = l2jserver.getProperty("InfoHTMLGMChat", false);
		ALLOW_ZONE_NAME = Boolean.parseBoolean(l2jserver.getProperty("EnableZoneNameCharacter", "false"));
		ZONE_NAME = l2jserver.getProperty("CharacterNameZone", "Aio");
		ANNOUNCE_DROP_ITEM = Boolean.parseBoolean(l2jserver.getProperty("AnnounceDropItem", "false"));
		GM_VIEW_PL_ON = Boolean.parseBoolean(l2jserver.getProperty("PlayersOnlineScreemMSG", "false"));
		...
		BLOCK_AIOX_PVPZONE = Boolean.parseBoolean(l2jserver.getProperty("BlockAiox_inPvpZone", "false"));
		USE_AIOX_OUTSIDE_PEACEZONE = Boolean.parseBoolean(l2jserver.getProperty("UseAioOnlyPeaceZone", "false"));
		
		ENABLE_FLAGZONE = Boolean.parseBoolean(l2jserver.getProperty("EnableFlag_inRaid_inFlagZone", "false"));
		ENABLE_CHAT_LEVEL = Boolean.parseBoolean(l2jserver.getProperty("EnableChatLevel", "True"));
		CHAT_LEVEL = Integer.parseInt(l2jserver.getProperty("ChatLevel", "80"));
		CMD_SKIN = Boolean.parseBoolean(l2jserver.getProperty("EnableSkinCMD", "True"));
		ENABLE_AIO_SYSTEM = Boolean.parseBoolean(l2jserver.getProperty("EnableAioSystem", "True"));
		AIO_TITLE = l2jserver.getProperty("AioTitle", "Aio");
		CHANGE_AIO_NAME = Boolean.parseBoolean(l2jserver.getProperty("ChangeAioName", "True"));
		ALLOW_AIO_NCOLOR = Boolean.parseBoolean(l2jserver.getProperty("AllowAioNameColor", "True"));
		AIO_NCOLOR = Integer.decode("0x" + l2jserver.getProperty("AioNameColor", "88AA88")).intValue();
		ALLOW_AIO_TCOLOR = Boolean.parseBoolean(l2jserver.getProperty("AllowAioTitleColor", "True"));
		AIO_TCOLOR = Integer.decode("0x" + l2jserver.getProperty("AioTitleColor", "88AA88")).intValue();
		AIO_ITEMID = Integer.parseInt(l2jserver.getProperty("ItemIdAio", "9945"));
		ALLOW_AIO_ITEM = Boolean.parseBoolean(l2jserver.getProperty("AllowAIOItem", "False"));
		ALLOW_AIOX_SET_ITEM = Boolean.parseBoolean(l2jserver.getProperty("AllowItems", "False"));
		if (ALLOW_AIOX_SET_ITEM) {
			String[] propertySplit4 = l2jserver.getProperty("AioxItems", "57,0").split(";");
		...
		if (ENABLE_AIO_SYSTEM) {
			String[] AioSkillsSplit = l2jserver.getProperty("AioSkills", "").split(";");
		...
		DONATESYSTEM = l2jserver.getProperty("DonateSystem", false);
		DONATE_HTML = l2jserver.getProperty("Donate_Html", false);
		
		DONATE_COIN_ID = Integer.parseInt(l2jserver.getProperty("DonateCoin_Id", "9511"));
		
		ENABLE_CHAT_VIP = l2jserver.getProperty("ChatVIP", false);
		VIP_SKINS = l2jserver.getProperty("SkinsVIP", false);
		VIP_SKILL = Boolean.parseBoolean(l2jserver.getProperty("Vip_Skill", "False"));
		VIP_XP_SP_RATES = l2jserver.getProperty("VipExp/SpRates", 1000);
		ENABLE_DROP_VIP = Boolean.parseBoolean(l2jserver.getProperty("EnableDropVIP", "False"));
		DROP_ITEM_VIP = l2jserver.getProperty("ListDropVIPItens", "");
		DROP_LIST_VIP = new ArrayList<>();
		for (String itemId : DROP_ITEM_VIP.split(","))
			DROP_LIST_VIP.add(Integer.parseInt(itemId));
		RATE_DROP_VIP = l2jserver.getProperty("RateDropVIP", 1);
		
		VIP_30_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Vip_30_Days_Price", "30"));
		VIP_60_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Vip_60_Days_Price", "60"));
		VIP_90_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Vip_90_Days_Price", "90"));
		VIP_ETERNAL_PRICE = Integer.parseInt(l2jserver.getProperty("Vip_Eternal_Price", "120"));
		
		HERO_30_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Hero_30_Days_Price", "30"));
		HERO_60_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Hero_60_Days_Price", "60"));
		HERO_90_DAYS_PRICE = Integer.parseInt(l2jserver.getProperty("Hero_90_Days_Price", "90"));
		HERO_ETERNAL_PRICE = Integer.parseInt(l2jserver.getProperty("Hero_Eternal_Price", "120"));
		
		MIN_ENCHANT = l2jserver.getProperty("Min_Enchant_Donate", 0);
		MAX_ENCHANT = l2jserver.getProperty("Max_Enchant_Donate", 0);
		DONATE_ENCHANT_PRICE = Integer.parseInt(l2jserver.getProperty("Enchant_Price", "120"));
		
		DONATE_NOBLE_PRICE = Integer.parseInt(l2jserver.getProperty("Noble_Price", "120"));
		DONATE_CLASS_PRICE = Integer.parseInt(l2jserver.getProperty("Change_Class_Price", "15"));
		DONATE_NAME_PRICE = Integer.parseInt(l2jserver.getProperty("Change_Name_Price", "15"));
		DONATE_SEX_PRICE = Integer.parseInt(l2jserver.getProperty("Change_Sex_Price", "15"));
		DONATE_ITEM = Integer.parseInt(l2jserver.getProperty("Coin_for_Status", "9511"));
		DONATE_ITEM_COUNT = Integer.parseInt(l2jserver.getProperty("Change_Status_Price", "15"));
		
		DONATE_ITEM_SKILL = Integer.parseInt(l2jserver.getProperty("Coin_for_Skills", "9511"));
		DONATE_ITEM_COUNT_SKILL = Integer.parseInt(l2jserver.getProperty("Change_Skills_Price", "15"));
		
		ANNOUNCE_HERO_ON_ENTER = Boolean.parseBoolean(l2jserver.getProperty("AnnounceHeroOnEnter", "false"));
		ANNOUNCE_HERO_ON_CUSTOM = Boolean.parseBoolean(l2jserver.getProperty("AnnounceHeroOnCustom", "false"));
		ANNOUNCE_CASTLE_LORDS = Boolean.parseBoolean(l2jserver.getProperty("AnnounceCastleLords", "false"));
		ANNOUNCE_HALL_OWNERS = Boolean.parseBoolean(l2jserver.getProperty("AnnounceEnterLeadersHall", "False"));
		
		ID_ITEM_ENCHANT = l2jserver.getProperty("ItemList_DropEnchanted");
		...
		ENCHANT_LEVEL = Integer.parseInt(l2jserver.getProperty("Enchant_level", "0"));
		
		START_VIP = l2jserver.getProperty("Start_vip_24hrs", false);
		
		STATUS_CMD = l2jserver.getProperty("StatusCMD", false);
		STATUS_CMD_INVENTORY = l2jserver.getProperty("StatusCMD_Inventory", false);
		STATUS_CMD_SKILLS = l2jserver.getProperty("StatusCMD_Skils", false);
		
		NEWS_1 = l2jserver.getProperty("News_url", "");
		NEWS_2 = l2jserver.getProperty("News2_url", "");
		NEWS_3 = l2jserver.getProperty("News3_url", "");
		NEWS_4 = l2jserver.getProperty("News4_url", "");
		DONATE_URL = l2jserver.getProperty("Donate_url", "");
		INFO_URL = l2jserver.getProperty("Info_url", "");
		
		ITEM_OBSERVER = Integer.parseInt(l2jserver.getProperty("Item_Observer", "0"));
		ITEM_BUY_QUANT_OBSERVER = Integer.parseInt(l2jserver.getProperty("Amount_Observer", "0"));
		
		//LUCY BOX 1
		try {
			String rewardList = l2jserver.getProperty("LuckyBoxRewards", "");
			for (String entry : rewardList.split(";")) {
				String[] parts = entry.trim().split(",");
				if (parts.length == 2) {
					int itemId = Integer.parseInt(parts[0]);
					int count = Integer.parseInt(parts[1]);
					LUCKY_BOX_REWARDS.add(new int[] { itemId, count });
				}
			}
		} catch (Exception e) {
			_log.warning("Failed to load LuckyBoxRewards: " + e);
		}
		
		try {
			String rewardList2 = l2jserver.getProperty("LuckyBox2Rewards", "");
			for (String entry : rewardList2.split(";")) {
				String[] parts = entry.trim().split(",");
				if (parts.length == 2) {
					int itemId = Integer.parseInt(parts[0]);
					int count = Integer.parseInt(parts[1]);
					LUCKY_BOX2_REWARDS.add(new int[] { itemId, count });
				}
			}
		} catch (Exception e) {
			_log.warning("Failed to load LuckyBox2Rewards: " + e);
		}

		
		
		MSG_CHAT_TRADE = l2jserver.getProperty("MsgChatVip", "");
		
		INFINITY_SS = l2jserver.getProperty("InfinitySS", false);
		INFINITY_ARROWS = l2jserver.getProperty("InfinityArrows", false);
		
		HERO_SKILL_SUB = Boolean.parseBoolean(l2jserver.getProperty("AllowHeroSkills_inSubClas", "false"));
		
		ALLOW_MANUTENCAO = Boolean.parseBoolean(l2jserver.getProperty("AllowManutencao", "false"));
		MANUTENCAO_TEXT = l2jserver.getProperty("ManutencaoMessageText", "Servidor em Manutencao!");
		
		CHAR_TITLE = Boolean.parseBoolean(l2jserver.getProperty("CharTitle", "false"));
		ADD_CHAR_TITLE = l2jserver.getProperty("TitleNewChar", "Welcome");
		ADD_NAME_COLOR = l2jserver.getProperty("NameColor", "FFFFFF");
		ADD_TITLE_COLOR = l2jserver.getProperty("TitleColor", "FFFFFF");
		SPAWN_CHAR = Boolean.parseBoolean(l2jserver.getProperty("CustomSpawn", "false"));
		
		SPAWN_X_1 = Integer.parseInt(l2jserver.getProperty("SpawnX_1", ""));
		SPAWN_Y_1 = Integer.parseInt(l2jserver.getProperty("SpawnY_1", ""));
		SPAWN_Z_1 = Integer.parseInt(l2jserver.getProperty("SpawnZ_1", ""));
		
		SPAWN_X_2 = Integer.parseInt(l2jserver.getProperty("SpawnX_2", ""));
		SPAWN_Y_2 = Integer.parseInt(l2jserver.getProperty("SpawnY_2", ""));
		SPAWN_Z_2 = Integer.parseInt(l2jserver.getProperty("SpawnZ_2", ""));
		
		SPAWN_X_3 = Integer.parseInt(l2jserver.getProperty("SpawnX_3", ""));
		SPAWN_Y_3 = Integer.parseInt(l2jserver.getProperty("SpawnY_3", ""));
		SPAWN_Z_3 = Integer.parseInt(l2jserver.getProperty("SpawnZ_3", ""));
		
		SPAWN_X_4 = Integer.parseInt(l2jserver.getProperty("SpawnX_4", ""));
		SPAWN_Y_4 = Integer.parseInt(l2jserver.getProperty("SpawnY_4", ""));
		SPAWN_Z_4 = Integer.parseInt(l2jserver.getProperty("SpawnZ_4", ""));
		
		ALLOW_CREATE_LVL = Boolean.parseBoolean(l2jserver.getProperty("CustomStartingLvl", "False"));
		CHAR_CREATE_LVL = Integer.parseInt(l2jserver.getProperty("CharLvl", "80"));
		CUSTOM_SUBCLASS_LVL = l2jserver.getProperty("CustomSubclassLvl", 40);
		
		CUSTOM_STARTER_ITEMS_ENABLED = Boolean.parseBoolean(l2jserver.getProperty("CustomStarterItemsEnabled", "False"));
		if (Config.CUSTOM_STARTER_ITEMS_ENABLED)
		{
			String[] propertySplit1 = l2jserver.getProperty("StartingCustomItemsMage", "57,0").split(";");
			...
			String[] propertySplit2 = l2jserver.getProperty("StartingCustomItemsFighter", "57,0").split(";");
		...
		DISABLE_CHAT = Boolean.valueOf(l2jserver.getProperty("DisableChat", "false"));
		DISABLE_CAPSLOCK = Boolean.valueOf(l2jserver.getProperty("DisableCapsLock", "false"));
		TRADE_CHAT_WITH_PVP = Boolean.valueOf(l2jserver.getProperty("TradeChatWithPvP", "false"));
		TRADE_PVP_AMOUNT = Integer.parseInt(l2jserver.getProperty("TradePvPAmount", "50"));
		GLOBAL_CHAT_WITH_PVP = Boolean.valueOf(l2jserver.getProperty("GlobalChatWithPvP", "false"));
		GLOBAL_PVP_AMOUNT = Integer.parseInt(l2jserver.getProperty("GlobalPvPAmount", "500"));
		CUSTOM_GLOBAL_CHAT_TIME = Integer.parseInt(l2jserver.getProperty("interval_ChatGlobal", "18000"));
		CUSTOM_HERO_CHAT_TIME = Integer.parseInt(l2jserver.getProperty("interval_ChatHero", "18000"));
		
		TALK_CHAT_ALL_CONFIG = Boolean.valueOf(l2jserver.getProperty("ChatAll_Protection", "false"));
		TALK_CHAT_ALL_TIME = Integer.parseInt(l2jserver.getProperty("Talk_ChatAll_Time", "15"));
		
		WYVERN_PVPZONE = Boolean.parseBoolean(l2jserver.getProperty("WyverbPvPZone", "False"));
		PARTY_PVPZONE = Boolean.parseBoolean(l2jserver.getProperty("DisablePartyPvPZone", "False"));
		PARTY_FLAGZONE = Boolean.parseBoolean(l2jserver.getProperty("DisablePartyFlagZone", "False"));
		OPEN_URL_ENABLE = l2jserver.getProperty("OpenUrlEnable", true);
		OPEN_URL_SITE = l2jserver.getProperty("OpenUrlSite", "");
		
		WYVERN_PROTECTION = Boolean.parseBoolean(l2jserver.getProperty("WyvernProtectionEnabled", "False"));
		ID_RESTRICT = l2jserver.getProperty("WyvernItemID", "10");
		...
		TITLE_MONSTER_SOLO = l2jserver.getProperty("Title_MonsterFarm", "");
		
		CUSTOM_DROP = Boolean.parseBoolean(l2jserver.getProperty("CustomDrop", "False"));
		
		CUSTOM_DROP_ITEM = l2jserver.getProperty("CustomDropItens", "");
		...
		CUSTOM_MONSTER = l2jserver.getProperty("List_Monster", "0");
		...
		String[] a = l2jserver.getProperty("DropList_Monster", "57,0").split(";");
		...
		DROP_PROTECTED_TIME = Integer.parseInt(l2jserver.getProperty("DropProtectedTime", "15"));
		
		DISABLE_GRADE_PENALTY = Boolean.parseBoolean(l2jserver.getProperty("DisableGradePenalty", "False"));
		DISABLE_WEIGHT_PENALTY = Boolean.parseBoolean(l2jserver.getProperty("DisableWeightPenalty", "False"));
		
		RESET_DAILY_ENABLED = l2jserver.getProperty("ResetDailyEnabled", false);
		RESET_DAILY_TIME = l2jserver.getProperty("ResetDailyStartTime", "20:00").split(",");
		
		RESTART_BY_TIME_OF_DAY = Boolean.parseBoolean(l2jserver.getProperty("EnableRestartSystem", "false"));
		RESTART_SECONDS = Integer.parseInt(l2jserver.getProperty("RestartSeconds", "360"));
		RESTART_INTERVAL_BY_TIME_OF_DAY = l2jserver.getProperty("RestartByTimeOfDay", "20:00").split(",");
		
		COLOR_WITH_ITEM = Boolean.parseBoolean(l2jserver.getProperty("ColorWithItem", "true"));
		COLOR_ITEM_ID = Integer.parseInt(l2jserver.getProperty("ColorItemID", "9325"));
		COLOR_NAME_ITEM_AMOUNT = Integer.parseInt(l2jserver.getProperty("ColorNameItemAmount", "100"));
		COLOR_TITLE_ITEM_AMOUNT = Integer.parseInt(l2jserver.getProperty("ColorTitleItemAmount", "100"));
		
		BANKING_SYSTEM_ENABLED = Boolean.parseBoolean(l2jserver.getProperty("BankingEnabled", "false"));
		BANKING_SYSTEM_GOLDBAR_ID = Integer.parseInt(l2jserver.getProperty("BankingGoldbar_Id", "1"));
		BANKING_SYSTEM_GOLDBARS = Integer.parseInt(l2jserver.getProperty("BankingGoldbarCount", "1"));
		BANKING_SYSTEM_ADENA = Integer.parseInt(l2jserver.getProperty("BankingAdenaCount", "500000000"));
	...
	private static final void loadSoloBoss()
	{
		...
		NPC_GK_SOLOBOSS  = bossSolo.getProperty("GkSpawnNpcEvent", 1); //GK
		String custom_spawn_location = bossSolo.getProperty("SpawnGKSoloBossLoc", "113852,-108766,-851");
		String custom_spawn_location_splitted[] = custom_spawn_location.split(",");
		NPC_GK_BOSS_SOLO_X[0] = Integer.parseInt(custom_spawn_location_splitted[0]);
		NPC_GK_BOSS_SOLO_X[1] = Integer.parseInt(custom_spawn_location_splitted[1]);
		NPC_GK_BOSS_SOLO_X[2] = Integer.parseInt(custom_spawn_location_splitted[2]);
		...
		NPCS_FLAG_RANGE = bossSolo.getProperty("RangeFlagPlayers", 1000);
		ALLOW_FLAG_ONKILL_BY_ID = bossSolo.getProperty("EnableFlagListBoss", false);
		NPCS_FLAG_IDS = bossSolo.getProperty("ListNpcsFlagPvP", "29020,29019,25517,25523,25524");
	 ...
	 */
	private static final void loadOfflineSystem()
	{
		final ExProperties offlinesall = initProperties(OFFLINE_SYSTEM_FILE);
		OFFLINE_TRADE_ENABLE = offlinesall.getProperty("OfflineTradeEnable", false);
		OFFLINE_CRAFT_ENABLE = offlinesall.getProperty("OfflineCraftEnable", false);
		OFFLINE_MODE_IN_PEACE_ZONE = offlinesall.getProperty("OfflineModeInPeaceZone", false);
		OFFLINE_MODE_NO_DAMAGE = offlinesall.getProperty("OfflineModeNoDamage", false);
		OFFLINE_SET_SLEEP = offlinesall.getProperty("OfflineSetSleepEffect", false);
		RESTORE_OFFLINERS = offlinesall.getProperty("RestoreOffliners", false);
		OFFLINE_MAX_DAYS = offlinesall.getProperty("OfflineMaxDays", 10);
		//Offline Player
		ENABLE_OFFLINE_PEACE_ZONE = offlinesall.getProperty("EnableOfflineInPeaceZone", false);
		ENABLE_OFFLINE_PLAYER = offlinesall.getProperty("EnableOfflineSystem", false);
		OFFLINE_PLAYER_SLEEP = offlinesall.getProperty("OfflinePlayerSleepEffect", false);
		ALLOW_NEW_OFFLINE_TITLE = offlinesall.getProperty("EnableTitleOfflinePlayer", false);
		TITLE_OFFLINE_PLAYER =  offlinesall.getProperty("TitleOfflinePlayer", "Disconnected");
		RESTORE_OFFLINERS_PLAYERS = offlinesall.getProperty("RestoreOfflinePlayers", false);
		OFFLINE_MAX_DAYS_PLAYERS  = offlinesall.getProperty("MaxDaysOnlinePlayers", 1);
	}
	...
	private static final void loadProtect()
	{
		...
		ENABLE_NAME_GMS_CHECK = Boolean.parseBoolean(protect.getProperty("CheckNamesGMS", "False"));
		GM_NAMES = protect.getProperty("GmNames", "").split(",");
		FREE_ITEMS_MULTISELL_BETA = Boolean.parseBoolean(protect.getProperty("FreeItemsMultisellBT", "False"));
		GM_STARTUP = protect.getProperty("GMStartProtections", true);
		DEFAULT_ACCESS_LEVEL = protect.getProperty("DefaultAccessLevel", 0);
		GM_HERO_AURA = protect.getProperty("GMHeroAura", false);
		GM_STARTUP_INVULNERABLE = protect.getProperty("GMStartupInvulnerable", true);
		GM_STARTUP_INVISIBLE = protect.getProperty("GMStartupInvisible", true);
		GM_STARTUP_SILENCE = protect.getProperty("GMStartupSilence", true);
		GM_STARTUP_AUTO_LIST = protect.getProperty("GMStartupAutoList", true);
	...
	private static final void loadFarmTime()
	{
		final ExProperties timezone = initProperties(FARM_TIME_FILE);
		OPEN_EFFECT_CLASSIC_TELEPORTER_FARM = timezone.getProperty("EffectTeleportClassicFarm", false);
...
//		OPEN_EFFECT_CLASSIC_TELEPORTER  = timezone.getProperty("EffectClassicInstanceTL", false);
	...
	private static final void loadLogin()
	{
		...
		RESTART_BY_TIME_OF_DAY_LOGIN  = Boolean.parseBoolean(server.getProperty("EnableRestartSystemLogin", "false"));
		LOGIN_RESTART_INTERVAL_BY_TIME_OF_DAY = server.getProperty("RestartByTimeOfDayLogin", "20:00").split(",");
		EXTERNAL_HOSTNAME = server.getProperty("ExternalHostname", "*");
		INTERNAL_HOSTNAME = server.getProperty("InternalHostname", "*");
