...
public abstract class AbstractNpcInfo extends L2GameServerPacket
{
	...
	public static class NpcInfo extends AbstractNpcInfo
	{
		...
		public NpcInfo(Npc cha, Creature attacker)
		{
			...
			else if (_npc.isChampionInvade())
				_title = (Config.TITLE_CHAMPION_INVADE);
			if (Config.SHOW_NPC_LVL && _npc instanceof Monster && !(_npc.getNpcId() == Config.monsterId) && !(Config.LIST_NPC_CUSTOM_MONSTER.contains(Integer.valueOf(_npc.getNpcId()))) && !(_npc instanceof RaidBoss) && !(_npc instanceof GrandBoss) && !_npc.isChampionInvade())
...
//			writeD(0x00);
			...
			else if (this._npc.isChampion()) 
			{
				writeC((Config.L2JMOD_CHAMPION_ENABLE_AURA == 3) ? Rnd.get(1, 2) : Config.L2JMOD_CHAMPION_ENABLE_AURA);
			}
			else
			{
				writeC(0x00);	
