...
public class SevenSigns
{
	...
	{
		try (Connection con = ConnectionPool.getConnection(); PreparedStatement st = con.prepareStatement(UPDATE_PLAYER))
		{
			for (StatsSet set : _playersData.values())
			{
	...
	{
		try (Connection con = ConnectionPool.getConnection(); PreparedStatement st = con.prepareStatement(UPDATE_STATUS))
		{
	...
	public CabalType setPlayerInfo(int objectId, CabalType cabal, SealType seal)
	{
		...
		else
		{
			...
			try (Connection con = ConnectionPool.getConnection(); PreparedStatement st = con.prepareStatement(INSERT_PLAYER))
			{
