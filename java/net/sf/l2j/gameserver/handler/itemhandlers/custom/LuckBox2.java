...
public class LuckBox2 implements IItemHandler {
    ...
    public void useItem(Playable playable, ItemInstance item, boolean forceUse) {
        ...
        if (result < 50 || Config.LUCKY_BOX2_REWARDS.isEmpty()) {
            activeChar.sendMessage(EMPTY_MESSAGE);
        } else {
            int[] reward = Config.LUCKY_BOX2_REWARDS.get(Rnd.get(Config.LUCKY_BOX2_REWARDS.size()));
            activeChar.addItem("Luck Box 2", reward[0], reward[1], activeChar, true);
        }
