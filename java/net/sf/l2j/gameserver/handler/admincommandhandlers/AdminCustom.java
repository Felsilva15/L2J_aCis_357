...
import net.sf.l2j.gameserver.instancemanager.VIPINFO;
...
public class AdminCustom implements IAdminCommandHandler
{
	...
	private static void initEventArena()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				net.sf.l2j.events.ArenaTask.SpawnEvent();
			}
	...
	private static void finishEventArena()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				net.sf.l2j.events.ArenaTask.finishEvent();
			}
	...
	private static void initPartyZone()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				net.sf.l2j.events.PartyZoneTask.SpawnEvent();
			}
		}, 1);
	}
	...
	private static void finishPartyZone()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				net.sf.l2j.events.PartyZoneTask.finishEvent();
			}
		}, 1);
	}
