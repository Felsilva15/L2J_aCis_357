				...
				if (_skillType == L2SkillType.DUMMY)
				{
					...
					for (Creature obj : activeChar.getKnownTypeInRadius(Creature.class, _skillRadius))
					{
						...
						if ((activeChar instanceof Player) && obj.isAgathion())
						   ...
						   if ((obj instanceof Player) && activeChar.isInsideZone(ZoneId.TIME_FARM) && obj.isInsideZone(ZoneId.TIME_FARM))
				                continue;
			...
			case TARGET_ALLY:
			{
				...
				if (player.getClan() != null)
				{
					for (Player obj : activeChar.getKnownTypeInRadius(Player.class, radius))
					{
						...
						if ((activeChar instanceof Player) && (getId() == 1305 || getId() == 1256) && obj.isInsideZone(ZoneId.PVP_CUSTOM))
							continue;
