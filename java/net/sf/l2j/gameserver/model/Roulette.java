...
//						}
						// Prepare the message with the good reason.
		    			 String itemName = (item.getEnchantLevel() > 0 ? "+" + item.getEnchantLevel() + " " : "") + item.getItem().getName();
		    			    player.sendPacket(new CreatureSay(0, 18, "System", "You have earned: " + itemName));
