...
import net.sf.l2j.gameserver.model.actor.ai.type.AgathionAI;
...
public class AgathionNpc extends Monster
{
	protected static final Logger _logPet = Logger.getLogger(AgathionNpc.class.getName());
	...
	public AgathionNpc(int objectId, NpcTemplate template)
	{
		super(objectId, template);
		
		setShowSummonAnimation(true);
	//	setAI(new L2AgathionAI(new AIAccessor()));
		setAI (new AgathionAI(this));
	}
