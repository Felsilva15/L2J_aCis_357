...
import net.sf.l2j.events.Arena9x9;
...
public class VillageMaster extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (player.isArena1x1() || player.isArena2x2() || player.isArena5x5() || player.isArena9x9())
		{
			player.sendMessage("you can't change classes at a party registed Tournament");
			return;
		}
		...
		else if (command.startsWith("Subclass"))
		{
			...
			player.abortCast();
		      ...
		      if (Arena2x2.getInstance().isRegistered(player) || Arena5x5.getInstance().isRegistered(player) || Arena9x9.getInstance().isRegistered(player))
		      {
