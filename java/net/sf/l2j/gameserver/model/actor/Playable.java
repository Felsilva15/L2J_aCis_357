...
//			if (DMEvent.isPlayerParticipant(player.getObjectId()) && DMEvent.isStarted()) // DM Event
//			{
//				if (DMConfig.LEAVE_BUFFS_DM_DIE)
//				{
//					stopAllEffectsExceptThoseThatLastThroughDeath();
//					if(killer instanceof Player)
//						if (player.getClan() != null)
//							Broadcast.ServerAnnounce(player.getName() + " from clan " + player.getClan().getName() + " took SELF! ^^");
//						else
//							Broadcast.ServerAnnounce(player.getName() + " took SELF! ^^");
//				}
//			}
//		}
...
//	        final Player player = (Player) this;
//	        
//	        // Check if the player is in any special zone and apply the logic in a single condition
//	        if (player.isArenaAttack() && Config.ALLOW_TOURNAMENT_DIE_LEAVE_BUFF)
//	        {
//	            stopAllEffectsExceptThoseThatLastThroughDeath();
//	            if (killer instanceof Player)
//	            {
		...
		else if (this instanceof Player)
		{
		    ...
		    else
		    {
		    	if(Config.LEAVE_ALL_BUFFS_WORLD_DIE) //Quando esta false, nao perde buff em lugar algum
		    	{
				    ...
				    {
				        if (player.getClan() != null)
				            Announcement.SelfAnnounce(getName() + " of Clan " + player.getClan().getName() + " was SELF !");
				        else
				            Announcement.SelfAnnounce(getName() + " was SELF !");
				    }	
		    	}
