...
public class Castle
{
	...
	public boolean addToTreasuryNoTax(long amount)
	{
		...
		try (Connection con = ConnectionPool.getConnection(); PreparedStatement ps = con.prepareStatement(UPDATE_TREASURY))
		{
	...
	public void setLeftCertificates(int leftCertificates, boolean save)
	{
		...
		if (save)
		{
			try (Connection con = ConnectionPool.getConnection(); PreparedStatement ps = con.prepareStatement("UPDATE castle SET certificates=? WHERE id=?"))
			{
	...
	public void checkItemsForMember(ClanMember member)
	{
		...
		{
			try (Connection con = ConnectionPool.getConnection(); PreparedStatement ps = con.prepareStatement(UPDATE_ITEMS_LOC))
			{
