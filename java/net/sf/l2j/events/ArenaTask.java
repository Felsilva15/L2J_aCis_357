	...
	protected static void waiter(long interval)
	{
	    ...
	    while (startWaiterTime + interval > System.currentTimeMillis() && !_aborted)
	    {
	        ...
	        if (_started)
	        {
	            ...
	            {
	                case 3600:  // 1 hour left
	                	Announcement.AnnounceEvents("Tournament: Party Event PvP");
	                	Announcement.AnnounceEvents("Tournament: Teleport in the GK to (Tournament) Zone");
	                	Announcement.AnnounceEvents("Tournament: Reward: " + ItemTable.getInstance().getTemplate(Config.ARENA_REWARD_ID).getName());
	                	Announcement.AnnounceEvents("Tournament: " + seconds / 60 / 60 + " hour(s) till event finish!");
	                    break;
	                ...
	                case 120:   // 2 minutes left
	                case 60:    // 1 minute left
	                	Announcement.AnnounceEvents("Tournament: " + seconds / 60 + " minute(s) till event finish!");
	                    break;
	                ...
	                case 1:     // 1 second left
	                	Announcement.AnnounceEvents("Tournament: " + seconds + " second(s) till event finish!");
	                    break;
	            }
	        }
